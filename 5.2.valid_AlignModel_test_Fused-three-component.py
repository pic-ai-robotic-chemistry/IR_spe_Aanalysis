    ...
    def run_experiments_and_save_results(self, X, y, P, indices):
        ...
        for rep in range(1, self.repeats + 1):
            ...
            try:
                ...
                test_csv_path = os.path.join(self.PredictionsSaveDir, f"align_pretrain_test_predictions_repeat_{rep}.csv")
...
if __name__ == "__main__":
    path = './data/three-component_dataset-BCD'
    predictor = SP(
